...
const SCENE_DEF = [
  {
    type: 'photo',
    title: 'Welcome to Travel360',
    source: asset('360_world.jpg'),
    audio: asset('cafe.wav'),
    next: 1,
    subtitle: 'Click above to be teleported to London!',
  },
  {
    type: 'video',
    title: 'Visit London Bridge',
    source: {url: asset('towerbridge360.mp4').uri},
    next: 2,
    subtitle: 'This is a 360 view, you can see traffic.',
  },
  {
    type: 'photo',
    title: 'View Together',
    source: asset('hall.png'),
    screen: {url: asset('video.mp4').uri},
    next: 0,
    subtitle: 'This is a 2d view, you can see it together.',
  },
];
